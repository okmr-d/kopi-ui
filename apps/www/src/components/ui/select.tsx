...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-between w-full cursor-pointer border border-input bg-background px-3 rounded-[8px] text-sm text-foreground data-[placeholder]:text-muted-foreground [&>span]:line-clamp-1",
