...
export const selectVariants = cva(
  [
    "peer inline-flex items-center justify-between w-full cursor-pointer border text-foreground placeholder:text-muted-foreground [&>span]:truncate",
...
>(({ className, children, variant, size, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className={selectIconVariants({ size })} />
